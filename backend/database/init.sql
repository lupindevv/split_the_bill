...
-- Insert sample user (password is 'test123')
...
(1, 'Caesar Salad', 'Romaine, parmesan, croutons', 'Appetizer', 8.00, true),
(1, 'Greek Salad', 'Tomatoes, cucumber, olives, feta', 'Appetizer', 7.50, true),
(1, 'Pasta Carbonara', 'Eggs, bacon, parmesan', 'Main Course', 14.00, true),
(1, 'Spaghetti Bolognese', 'Ground beef, tomato sauce', 'Main Course', 13.50, true),
(1, 'Tiramisu', 'Italian coffee-flavored dessert', 'Dessert', 6.50, true),
(1, 'Chocolate Cake', 'Rich chocolate cake', 'Dessert', 6.00, true),
